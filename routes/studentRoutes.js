...
router.get('/:schoolId', protect, authorize(['schoolAdmin']), getAllStudents);  // Only schoolAdmin can get students for a school
router.get('/:studentId', protect, getStudentById);  // Anyone can get a student by ID
